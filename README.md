...
| `kelolakelas-billing-service` | `main` | `f273afeff419bcb77fd510e7d945206fb48f91ad` | KEL-28 paid/failed callback emails to stored billing contact (PR #18); PR and post-merge CI gate passed |
