...
| `kelolakelas-academic-service` | `main` | `ebb6902010ab89ef7d2788e16f21ac5f23245767` | KEL-80 merged; every tenant permission check sends the token's `member_id`, a tenant token without a usable `member_id` is 403 (PR #20); PR and post-merge CI gate passed |
