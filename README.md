...
| `kelolakelas-academic-service` | `main` | `2f22558ca2cd5d01e6d8ad2e8d20c55daddfa558` | KEL-51 merged; permanent schedule/tutor replacements retain validity and capacity and transfer live enrollments (PR #17); PR and post-merge CI gate passed |
| `kelolakelas-billing-service` | `main` | `5286a66f4ada37107de9061a2edc9b1d90eb9fcc` | KEL-75 merged; sender_email validated (omitempty,email) and stored as Subscription/Transaction BillingEmail for invoices and reminders (PR #14); PR and post-merge CI gate passed |
