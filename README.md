...
|---|---|---|---|
| `kelolakelas-web` | `main` | `bf9211c1aea10d8c25456c8a4e088d1c40ab7908` | KEL-54 duplicate enrollment message and status link on class page (PR #34); PR CI gate passed |
...
| `kelolakelas-academic-service` | `main` | `ff462d6592e66c570fafc86d218dc899bc0a47cc` | KEL-54 duplicate enrollment answers 409 `code: duplicate_enrollment` (PR #23); PR and post-merge CI gate passed |
