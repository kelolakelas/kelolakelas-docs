...
> **Superseded in part by ADR 0031:** KEL-97 adds one in-process runtime consumer of the applied `identity/platform/TENANT_REGISTRATION_OPEN` report. Other catalog entries retain the record-only behavior below.
